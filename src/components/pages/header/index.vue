...
<template>
    <div class="header-boss">
       ...
       <div class="header-boss-2">
           ...
           <div class="header-sj-box">
               ...
               <div class="header-menu">
                   ...
                   <div class="header-menu-text">
                       <ul>
                           <li class="header-menu-top"><a href="" class="header-menu-left">订单查询</a><a href="">订单查询</a></li>
           ...
           <!-- 右区域数据3 -->
           <div class="header-sj-box3">
               <div class="header-sj-title">
                   <span>销售情况</span>
               </div>
               <div class="header-sj-c">
                   <div id="main2"></div>
               </div>
           </div>
       </div>
