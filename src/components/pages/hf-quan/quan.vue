 ...
 <el-card class="box-card">
  ...
  <el-table stripe
    ...
    <el-table-column
      ...
      label="操作">
      <template slot-scope= "scope">
            <el-button  type="text" size="small" align="center" @click="checkPersonDetail(scope.row)">修改</el-button>
    </template>
    </el-table-column>
  </el-table>
</el-card>
      ...
      >
        ...
        <el-form-item label="描述" prop="discountCouponDesc" style="margin-top:20px;" >
         <el-input
            ...
            :rows="4"
            placeholder="请输入内容"
            v-model="formquan.discountCouponDesc" maxlength="60" show-word-limit>
            </el-input>
        </el-form-item>
        ...
        <el-row v-if='formquan.discountCouponType ===0'>
            <el-col :span="1">
                 <el-form-item label="优惠额度" style="margin-top:20px;" >
                </el-form-item>
            </el-col>
            <el-col :span="4">
                <el-form-item label="满" prop="useLimit.full" style="margin-top:20px;" >
                     <el-input v-model="formquan.useLimit.full" style="width:100px;" autocomplete="off"><i slot="suffix" style="font-style:normal;margin-right: 10px;">元</i></el-input>
            </el-form-item>
            </el-col>
               <el-col :span="4">
                 <el-form-item label="减" prop="useLimit.minus" style="margin-top:20px;" >
                <el-input v-model="formquan.useLimit.minus" style="width:100px;" autocomplete="off"><i slot="suffix" style="font-style:normal;margin-right: 10px;">元</i></el-input>
            </el-form-item>
            </el-col>
        </el-row>
          <el-row v-if='formquan.discountCouponType ===1' >
            ...
            <el-col :span="4">
               ...
               <el-col :span="4">
                ...
                <el-input v-model="formquan.useLimit.minus" style="width:100px;" autocomplete="off"><i slot="suffix" style="font-style:normal;margin-right: 10px;">%</i></el-input>
            </el-form-item>
            </el-col>
        </el-row>
