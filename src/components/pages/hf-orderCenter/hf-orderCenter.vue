<template>
	<div>
		...
		<el-select @change="getlistByType" v-model="orderTypeValue" style="margin-bottom: 30px;" filterable placeholder="请选择">
			<el-option v-for="item in orderType" :key="item.orderDesc" :label="item.orderDesc" :value="item.orderDesc">
			</el-option>
		</el-select>
		...
		<el-drawer :visible.sync="drawer">
			...
			<el-select v-model="updata.value" @change="updateStatus" placeholder="请选择" style="margin-left:20px;">
				<el-option v-for="item in statusData" :key="item.hfName" :label="item.hfName" :value="item.hfName"></el-option>
			</el-select>
		</el-drawer>
	</div>
</template>
