...
<div>
  ...
  <el-dialog title="上传头像" :limit="1" :visible.sync="pictureVisible" width="30%">
    <el-upload :auto-upload="false" class="avatar-uploader" action="" :limit="1" :on-change="handleChange">
    ...
    <el-table :data="userData" stripe style="width: 100%">
      ...
      <el-table-column label="头像">
        <template slot-scope="scope">
          <img src="http://5b0988e595225.cdn.sohucs.com/q_70,c_zoom,w_640/images/20200105/c5162a9d6f484ce3b8ff464b27f8865f.jpeg" min-width="70" height="70" />
          <div>
