<template>
  <section>
           ...
           <el-table-column prop="id" label="商品id" align="center">
            ...
            <el-table-column fixed="right" label="操作" width="260">
              <template slot-scope="scope">
                <el-button type="primary" plain size="small" @click="addgui(scope.row)" style="margin-bottom: 10px;">规格</el-button>
    ...
    <el-dialog title="编辑"  :visible.sync="editFormVisible3" :close-on-click-modal="false">
      ...
      <el-form :inline="true" :data="bianrow" :model="addForm" label-width="80px" :rules="bianRules" ref="bianForm">
        <el-form-item label="商品名称" prop="hfName">
        ...
        <el-form-item label="商品分类">
          <el-select v-model="value4" placeholder="请选择" @change="changeQuentitySubject(index)">
